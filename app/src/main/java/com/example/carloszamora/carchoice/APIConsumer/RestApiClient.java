...
public class RestApiClient extends AsyncTask<String,String,String> {
     ...
     */
    public RestApiClient(String Url,String Token, String MethodName, Object Params, METHOD Method, RestInterface restInterface) {
        this.Url = Url;
        this.Token = Token;
        this.Params = Params;
        ...
        try {
            ...
            if ((statusCode != HttpURLConnection.HTTP_CREATED) && (statusCode != HttpURLConnection.HTTP_OK) && (statusCode != HttpURLConnection.HTTP_ACCEPTED)) {
                ...
                if (content != null) {
                    ...
                    try {
                        errorJson.put("message", sb.toString());
                        errorJson.put("error", true);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    Log.d(TAG, "doInBackground(): connection failed: response: " + errorJson.toString());
